...
public class AuthorAllListAdapter extends RecyclerView.Adapter<AuthorAllListAdapter.ViewHolder> {

    Context context;
    ArrayList<Author> authorAllListArray;

    public AuthorAllListAdapter(Context context, ArrayList<Author> authorAllListArray) {
        this.context = context;
        this.authorAllListArray = authorAllListArray;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        final String author_id = authorAllListArray.get(position).getAuthor_id();
        final String author_name = authorAllListArray.get(position).getAuthor_name();
        String author_img = authorAllListArray.get(position).getAuthor_img();

        viewHolder.txtAllCatName.setText(author_name);
    ...
    public int getItemCount() {
        return authorAllListArray.size();
    }
