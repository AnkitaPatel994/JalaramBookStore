...
import com.iterationtechnology.jalarambook.adapter.AuthorAllListAdapter;
...
public class AuthorListActivity extends AppCompatActivity
    ...
    RecyclerView rvAllAuthorList;
    ArrayList<Author> AuthorAllListArray = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AuthorAllListArray.clear();

        session = new SessionManager(AuthorListActivity.this);
        ...
        if (flag == 1)
        {
            ...
            nav_header_ll.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(AuthorListActivity.this, MyProfileActivity.class);
                    startActivity(i);
                }
            });
        }
        else if (flag == 0)
        {
            ...
            nav_header_ll.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i = new Intent(AuthorListActivity.this, SignInActivity.class);
                    startActivity(i);
                }
            });
        }

        rvAllAuthorList = (RecyclerView) findViewById(R.id.rvAllAuthorList);
        rvAllAuthorList.setHasFixedSize(true);

        RecyclerView.LayoutManager manager = new GridLayoutManager(getApplicationContext(), 1);
        rvAllAuthorList.setLayoutManager(manager);
        ...
        authorListCall.enqueue(new Callback<AuthorList>() {
            ...
            public void onResponse(Call<AuthorList> call, Response<AuthorList> response) {
                ...
                if (Status.equals("1"))
                {
                    ...
                    AuthorAllListArray = response.body().getAuthorList();
                    AuthorAllListAdapter authorAllListAdapter = new AuthorAllListAdapter(AuthorListActivity.this, AuthorAllListArray);
                    rvAllAuthorList.setAdapter(authorAllListAdapter);
                }
                else
                {
                    Log.d("message",""+message);
            ...
            public void onFailure(Call<AuthorList> call, Throwable t) {
                Toast.makeText(AuthorListActivity.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
            }
        });
